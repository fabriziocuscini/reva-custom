...
| Styled wrappers, namespace exports | `packages/components/src/components/` | Wire recipes to Ark UI parts                                   |
| `createStyleContext` utility       | `packages/components/src/utils/`      | Distributes recipe classes to compound component parts         |
...
```typescript
// packages/components/src/utils/create-style-context.tsx
