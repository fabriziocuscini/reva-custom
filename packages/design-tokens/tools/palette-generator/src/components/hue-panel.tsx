...
import { HUE_PARAMS_DARK, HUE_PARAMS_LIGHT } from '@/lib/constants'
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Tooltip>
                ...
                <TooltipContent>Reset light-end hue</TooltipContent>
              </Tooltip>
            </div>
            {HUE_PARAMS_LIGHT.map((config) => (
              <ParamSlider
                key={config.key}
                config={config}
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Tooltip>
                ...
                <TooltipContent>Reset dark-end hue</TooltipContent>
              </Tooltip>
            </div>
            {HUE_PARAMS_DARK.map((config) => (
              <ParamSlider
                key={config.key}
                config={config}
                value={params[config.key]}
