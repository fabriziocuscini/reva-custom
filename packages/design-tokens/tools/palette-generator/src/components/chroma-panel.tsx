...
import { CHROMA_PARAMS_DARK, CHROMA_PARAMS_LIGHT } from '@/lib/constants'
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Tooltip>
                ...
                <TooltipContent>Reset light-end chroma</TooltipContent>
              </Tooltip>
            </div>
            {CHROMA_PARAMS_LIGHT.map((config) => (
              <ParamSlider
                key={config.key}
                config={config}
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Tooltip>
                ...
                <TooltipContent>Reset dark-end chroma</TooltipContent>
              </Tooltip>
            </div>
            {CHROMA_PARAMS_DARK.map((config) => (
              <ParamSlider
                key={config.key}
                config={config}
                value={params[config.key]}
